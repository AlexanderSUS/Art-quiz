export const ARTIST_QUIZ = 'artist';
export const PICTURE_QUIZ = 'picture';

export const RATING_GRAND = 'grand';
export const RATING_CONGRATS = 'congrats';
export const RATING_GAMEOVER = 'gameover';
...
export const RESULT_CONGRATS = 7;
export const RESULT_GAMEOVER = 6;
